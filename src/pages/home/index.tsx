    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      <div className="space-y-6 p-5">
        ...
        <div className="rounded-xl bg-white p-6 text-center">
          ...
          {shouldPromptQRScan ? (
            ...
            <div className="flex min-h-[65vh] flex-col items-center justify-center px-6 text-center">
              ...
              <p className="mb-6 max-w-sm text-sm text-gray-500">
                To place an order, simply scan the QR code available on your table.  
                This will automatically load your table and show you the menu.
              </p>
          ...
          <div className="flex min-h-[70vh] flex-col items-center justify-center px-6 text-center space-y-6">
            ...
            <div className="max-w-sm">
              ...
              <p className="text-muted-foreground mt-2">
                A waiter will be with you shortly — or you can start exploring the menu
                and place your order right here.
              </p>
            </div>
      ...
      <Button
        ...
        size="icon"
        className="bg-primary hover:bg-primary/90 fixed right-5 bottom-24 z-40 h-14 w-14 rounded-full shadow-lg hidden"
      >
