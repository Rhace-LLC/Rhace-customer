    ...
    <div className="flex min-h-[450px] w-full flex-col items-center justify-center bg-transparent px-6 py-12">
      <div className="flex w-full max-w-[320px] flex-col items-center text-center">
        ...
        <div className="space-y-3">
          ...
          <p className="text-[14px] leading-relaxed font-medium text-gray-400">
            Your tray is currently empty. Orders will appear here once you’ve
        ...
        <div className="mt-10 w-full space-y-4">
          <Link to={"/menu"}>
            <Button className="h-12 w-full rounded-2xl bg-black text-[13px] font-bold tracking-wide text-white shadow-lg shadow-black/5 transition-all hover:bg-gray-800 active:scale-[0.98]">
              Browse Menu
            </Button>
          </Link>
