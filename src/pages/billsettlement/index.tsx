  ...
  return (
    <div className="mx-auto max-w-xl space-y-6 px-4 py-6">
      ...
      <div className="rounded-xl bg-white p-4 shadow-sm">
        ...
        {/* Footer Total */}
        <div className="mt-4 flex justify-between text-sm font-semibold text-foreground">
          <span>Total</span>
          <span>₦10,500</span>
        </div>
      </div>
      ...
      <div className="rounded-xl bg-white p-4 shadow-sm">
        <button
            onClick={() => setShowDialog(true)} className="h-12 w-full rounded-lg bg-primary text-sm font-medium text-white transition hover:bg-primary/90 active:scale-95">
          Pay for my bill
        </button>
      ...
      <div className="rounded-xl bg-white p-4 shadow-sm">
        ...
        <button className="w-full rounded-lg border border-primary px-4 py-2 text-sm font-medium text-primary transition hover:bg-primary hover:text-white">
