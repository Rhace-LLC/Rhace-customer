...
const BillSettlement = () => {
  ...
  const fetchGroupBill = async () => {
    return await getDiningGroupBillSummary(groupOrder?.id || "", auth.token);
  };
    ...
    <div className="mx-auto max-w-2xl space-y-12 px-4 py-8">
      ...
      <div className="relative rounded-[0.5rem] border border-gray-100 bg-white p-8 shadow-sm transition-all hover:shadow-md">
        ...
        <div className="mt-3 space-y-3 border-t border-gray-200 pt-3">
          ...
          <div className="mt-2 flex justify-between border-t border-gray-100 pt-3 text-[16px] font-semibold text-gray-900">
            <span>Total Due</span>
      ...
      <div className="space-y-6">
        <div className="flex items-end justify-between px-2">
          <div className="space-y-1">
            <h4 className="text-[16px] font-semibold tracking-tight text-gray-900">
              Other Diners
            </h4>
            <p className="text-[14px] text-gray-400">
              Cover a friend’s bill or keep it separate.
            </p>
          </div>
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <button
                    ...
                    className={cn(
                      "mt-1 text-[13px] font-semibold underline-offset-4 transition-all hover:underline",
      ...
      <div className="space-y-4 rounded-[2.5rem] bg-gray-50 p-8">
        <button className="flex h-16 w-full items-center justify-center rounded-[1.5rem] bg-black text-[15px] font-semibold tracking-tight text-white shadow-xl shadow-black/10 transition-all hover:bg-gray-800 active:scale-95">
          Proceed to Payment • ₦{totalToPay.toLocaleString("en-NG")}
        </button>

        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <p className="max-w-[200px] text-center text-[13px] leading-tight text-gray-400 sm:text-left">
            {billingText}
          </p>
